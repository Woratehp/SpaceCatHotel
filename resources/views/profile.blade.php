<title>โปรไฟล์ | Spacecathotal</title>
        ...
        <div class="relative rounded-lg border mt-[5em] mx-auto w-[55em] shadow-lg pb-[7em]">
            ...
            <div class = "flex relative rounded-lg border mt-[4em] mx-auto w-[50em]"><img src="{{ URL('/picture/'.'email.png') }}"class="mx-3 my-3 w-12 h-12 ">
                <div class="mt-2">
                    ชื่อผู้ใช้ :
                    <div class=" ">
                    <input id="editprofile_username" class="text-gray-500 font-light p-2 outline-none"  type="username" name="username" placeholder="ชื่อผู้ใช้" value="{{ $profile->username }}" readonly> 
                    </div>
                </div>
            </div> 
            ...
            <div class = "flex relative rounded-lg border mt-[5px] mx-auto w-[50em]"><img src="{{ URL('/picture/'.'users.png') }}"class="mx-3 my-3 w-12 h-12 ">
                <div class="mt-2">
                    ชื่อ :
                    <div class=" ">
                        <input id="editprofile_name" class="text-gray-500 font-light p-2"  type="name" name="name" placeholder="ชื่อนามสกุล" value="{{ $profile->firstname}}"> 
                    </div>
                </div>
            </div>
            ...
            <div class = "flex relative rounded-lg border mt-[5px] mx-auto w-[50em]"><img src="{{ URL('/picture/'.'users.png') }}"class="mx-3 my-3 w-12 h-12 ">
                <div class="mt-2">
                    นามสกุล :
                    <div class=" ">
                    <input id="editprofile_lastname" class="text-gray-500 font-light  p-2"  type="name" name="name" placeholder="นามสกุล" value="{{ $profile->lastname}}"> 
                    </div>
                </div>
            ...
            <div class = "flex relative rounded-lg border mt-[5px] mx-auto w-[50em]"><img src="{{ URL('/picture/'.'tell.png') }}"class="mx-3 my-3 w-12 h-12 ">
                <div class="mt-2">
                    เบอร์โทร :
                    <div class=" ">
                    <input id="editprofile_tel" class="text-gray-500 font-light p-2 "  type="tel" name="tel" placeholder="เบอร์โทร" value="{{ $profile->tell }}"> 
                    </div>
                </div>
        ...
        <div class="relative rounded-lg border mt-[2em] mx-auto w-[55em] shadow-lg pb-[5em]">
            ...
            <div class = "flex relative rounded-lg border mt-[4em] mx-auto w-[50em]"><img src="{{ URL('/picture/'.'padlock.png') }}"class="mx-3 my-3 w-12 h-12 ">
                <div class="mt-2">
                    รหัสผ่าน :
                    <div class=" ">
                    <input id="editprofile_password" class="font-light p-2"  type="password" name="password" placeholder="รหัสผ่าน"> 
                    </div>
                </div>
            </div>
            ...
            <div class = "flex relative rounded-lg border mt-[5px] mx-auto w-[50em]"><img src="{{ URL('/picture/'.'unlock.png') }}"class="mx-3 my-3 w-12 h-12 ">
                <div class="mt-2">
                    ยืนยันรหัสผ่าน :
                    <div class=" ">
                    <input id="editprofile_confirmpassword" class="font-light p-2"  type="password" name="confirmpassword" placeholder="ยืนยันรหัสผ่าน"> 
                    </div>
                </div>          
            </div>
