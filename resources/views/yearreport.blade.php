...
@section('Content')
        <div class="relative h-screen">         
            <div class="border border-gray-300 relative mt-4 flex items-center py-3">    
                ...
                <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="mr-[3em] text-dark bg-gray-100 hover:bg-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center " type="button">รายงานประจำปี <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                    ...
                    type: 'bar',
                        ...
                        options: {
                            ...
                            plugins: {
                                ...
                                title: {
                                    display: true,
                                    text: 'กราฟรายงานประจำปี', // กำหนดชื่อของกราฟ
