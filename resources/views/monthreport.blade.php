...
@section('Content')
        <div class="relative h-screen">         
            <div class="border border-gray-300 relative mt-4 flex items-center py-3">    
                ...
                <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="mr-[3em] text-dark bg-gray-100 hover:bg-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center " type="button">รายงานประจำเดือน <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                ...
                <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                        <li>
                            <a href="dayreport" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">รายงานประจำวัน</a>
                        </li>
                        <li>
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/flowbite/2.2.0/flowbite.min.js"></script>
            <script>
                ...
                // ตรวจสอบว่ามีข้อมูลในช่วง 30 วันที่ผ่านมาหรือไม่
                if (thirtyDaysAgo <= '{{ $startDate }}') {
                    myChart.data.labels.push('{{ $startDate }}');
                    myChart.data.datasets[0].data.push('{{ $totalReservations }}');
                    myChart.update();
                }
            </script>
 @endsection