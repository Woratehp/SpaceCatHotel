...
@section('Content')  
        <div class="border border-gray-300 relative mt-4 flex items-center py-3">    
                <div class= " flex mx-auto text-xl">
                    <span>รายละเอียดการจองอาบน้ำและตัดขน</span>
                </div>
            </div>
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                @foreach ($payshower as $payshower)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">
                            {{$payshower->shower_serve}}
                        </td>
                        <td class="px-5 py-4">
                            {{ $payshower->shower_date }}
                        </td>
                        <td class="px-6 py-4">
                            {{ $payshower->shower_time }}
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="flex items-center px-6 py-4"> 
                            <button data-image="{{ URL('/uploads/'.$payshower->shower_qr) }}" class="btn-payment-image font-medium text-blue-600 dark:text-blue-500 hover:underline">ตรวจสอบ </button>
                            <button class="btn-confirm-payment font-medium text-blue-600 dark:text-blue-500 hover:underline ms-3"
                            data-payshower_id="{{ $payshower->shower_id }}">ยืนยัน</button>
                        </td>
                    </tr>
                @endforeach             
                </tbody>
