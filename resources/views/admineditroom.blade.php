       ...
       <div class=" flex grid grid-cols-5  gap-2 mt-[5em] px max-lg:grid max-lg:grid-cols-2 max-md:grid-col-1 px-[6em]">
                 ...
                 @if(sizeof($rooms))
                    @foreach($rooms as $room)
                        <div class= "relative border border-gray-200 rounded-2xl shadow-xl duration-500 hover:scale-105 hover:shadow-xl flex-wrap ">
                            <div class="relative">
                            ...
                            <div class = "mt-[1em] flex-col space-y-1 px-3 mb-[0.7em]">
                                ...
                                <div class = "mt-[1em] ">
                                    <button type="button" class="btn-room-delete w-full text-amber-600 border border-[C09369] rounded-full py-1 hover:bg-red-500 hover:text-white duration-300"
                ...
                <div id="modal-details-room1" class="modal hidden fixed z-[100] flex my-auto left-0 top-0 w-[100%] h-[100%] overflow-auto ">
                    <!-- START MODEL CONTENT -->
                    <div class="modal-content bg-white m-auto p-[10px] rounded-md drop-shadow-2xl w-[50%] h-[65%] max-md:w-[100%] ">
                            ...
                            <div class = "border rounded-lg shadow-xl h-[90%]" >
                                    ...
                                    <div class="whitespace-nowrap flex-col h-fit ml-[3em] mr-[3em]">
                                        ...
                                        <div class="flex gap-2">
                                            <input id="room_size" class="block py-2.5 w-full text-sm bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer"  type="number" name="name" placeholder="ขนาดของห้อง(cm.)" > 
                                            <input id="room_hight" class="block py-2.5 w-full text-sm bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer"  type="number" name="name" placeholder="ความสูงของห้อง(cm.)" > 
                                        </div>
                                        <input id="room_price" class="block py-2.5 w-full text-sm bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer"  type="number" name="name" placeholder="กรุณากรอกราคาห้องพัก / 1 วัน (บาท)" >
                ...
                <div id="modal-details-room" class="modal hidden fixed z-[100] flex my-auto left-0 top-0 w-[100%] h-[100%] overflow-auto  ">
                    ...
                    <div class="modal-content bg-white m-auto p-[10px] rounded-md drop-shadow-xl w-[90%] max-md:w-[100%]">
                        <input type="hidden" id="room-id-clear">
                        <div class="flex items-center">
                            <p class="text-[20px] font-bold w-full ml-4 text-center">รายละเอียดห้อง</p>
                        ...
                        <div class="mt-4 grid grid-cols-2 px-[5em] gap-4 ">
                            ...
                            <div class = "grid grid-cols-2 border rounded-lg shadow-xl ">
                                ...
                                <div class="col-span-2 grid grid-cols-2">
                                   ...
                                   <div class="grid grid-cols-3 mx-1 my-2">
                                       ...
                                       <div class= "flex-col">
                                           <p class="whitespace-nowrap">จำนวนแมว :</p>
                                           <p id="room_cat" class="whitespace-nowrap">จำนวนแมว :</p> 
                                       </div>           
                                   </div>
                                </div>
                            ...
                            <!-- start grid2 -->
                                <div class = "  border rounded-lg shadow-xl " >
                                    ...
                                    <div class=" mt-3 h-[12em] bg-gray-200 rounded-lg">
                                        <div class="col-span-2 ml-10 mt-5">
                                        ...
                                        <p class=" border-t-2 border-gray-300 w-full col-span-2"></p>
                                        <div class="col-span-2 ml-10 mt-4">
                                            ...
                                            <div class="flex font-light  text-sm ">
                                                ...
                                                <button class="btn-clear-room rounded-lg px-4 py-2 bg-red-700 text-green-100 hover:bg-red-400 duration-300 float-right mr-[4em]">เคลียร์ห้อง</button>                              
                                        </div>
                                     </div>  
                                </div>
                                 <!-- end -->
                ...
                <script>
                    ...
                    $(document).ready(function() {
                        $('.btn-details-room').on('click', function() {
                            ...
                            $('.modal-content #room-id-clear').val($(this).data('room_id'));
                            $('.btn-clear-room').attr('data-room-id', $(this).data('room_id'));
                        ...
                        $('.btn-room-delete').on('click', function () {
                            Swal.fire({
                                title: `คุณแน่ใจหรือไม่? <br><b class="text-xl font-medium">(ชื่อห้อง: ${$(this).data('room_name')})</b>`,
                        ...
                        $('.btn-clear-room').on('click', function() {
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ConfirmRoomClear($(this).data('room-id'));
                                }
                            })
                        });
                    });

                function ConfirmRoomClear(room_id) {
                    fetch("{{ Route('ConfirmRoomClear') }}", {
                        method: "POST",
                        headers: {
